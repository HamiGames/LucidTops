...
DEFAULT_MASTER_SECRETS_NAME = "Master.secrets"
...
# Master.secrets (Proxy-synced) loads first so Tor/SOCKS/onion/ProxyGate keys win.
CONTAINER_SECRETS_SPECS: tuple[tuple[str, str], ...] = (
    ("MASTER_SECRETS_FILE", DEFAULT_MASTER_SECRETS_NAME),
